...
function loadTimeline(scrollView, ignoreStats) {
...
function getDateHTML(date, est) {
	...
	if (est == "md") {
		...
		str = "<b>" + m + "</b><b>" + d.getDate() + "</b><b>" + d.getFullYear() + "</b>";
	}
	return str;
}
...
function filter(e) {
	var element = e.target || e.srcElement;
	if (element.children[1].children[0].textContent == "Hide Wars") {
		hideWars = true;
		element.children[1].children[0].innerHTML = "Show Wars";
		element.className = "filter-enabled";
		element.children[0].src = "/static/images/icons/x.svg";
		loadTimeline(false);
	}
	else if (element.children[1].children[0].textContent == "Show Wars") {
		hideWars = false;
		element.children[1].children[0].innerHTML = "Hide Wars";
		element.className = "";
		element.children[0].src = "/static/images/icons/checkmark.svg";
		loadTimeline(false);
	}
	else if (element.children[1].children[0].textContent == "Hide Regular Events") {
		hideRegularEvents = true;
		element.children[1].children[0].innerHTML = "Show Regular Events";
		element.className = "filter-enabled";
		element.children[0].src = "/static/images/icons/x.svg";
		loadTimeline(false);
	}
	else if (element.children[1].children[0].textContent == "Show Regular Events") {
		hideRegularEvents = false;
		element.children[1].children[0].innerHTML = "Hide Regular Events";
		element.className = "";
		element.children[0].src = "/static/images/icons/checkmark.svg";
		loadTimeline(false);
	}
