...
var subscribers25000 = Math.floor(new Date(2023, 7, 31).getTime() / 84000000);
var subscribers30000 = Math.floor(new Date(2023, 8, 5).getTime() / 84000000);
//------------------------------
...
function drawTimeline() {
	...
	while (i < currentDay) {
		...
		else if (i == subscribers25000) {
			addMilestone("25,000 Subscribers!", "", "", 0, false, false, (i - initialDay) * lineSpacing + 25);
		}
		else if (i == subscribers30000) {
			addMilestone("30,000 Subscribers!", "", "", -60, false, false, (i - initialDay) * lineSpacing + 25);
		}
		//------------------------------
