var navLinks = [
	{
		...
		url:"/channel",
		width:170,
		date:new Date(2023, 10, 17), //year, month(from 0), day
		dropdownURLs:[
			{
				title:"Overview",
	...
	},
	{
		...
		url:"",
		width:140,
		date:new Date(2024, 2, 12), //year, month(from 0), day
		dropdownURLs:[
			{
				title:"Factsheets",
				url:"/factsheets",
			...
			},
			{
				...
				date:new Date(2024, 0, 21), //year, month(from 0), day
			},
			{
				title:"BT-JS",
				url:"/bt-js",
				date:new Date(2024, 0, 20), //year, month(from 0), day
			},
		],
	},
	{
